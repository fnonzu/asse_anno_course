...
# Load the data
anno_data=read.table("/data/users/mvolosko/asse_anno_course/annotations/output/EDTA_annotation/assembly.fasta.mod.EDTA.raw/assembly.fasta.mod.LTR.intact.raw.gff3",header=F,sep="\t")
head(anno_data)
# Get the classification table
classification=fread("/data/users/mvolosko/asse_anno_course/annotations/output/EDTA_annotation/assembly.fasta.mod.EDTA.raw/assembly.fasta.mod.LTR.intact.raw.fa.anno.list")
